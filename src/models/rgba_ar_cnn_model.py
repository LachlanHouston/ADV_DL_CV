...
class Encoder(nn.Module):
    ...
    def __init__(self, in_channels=4):  # Changed from 1 to 4 for RGBA
        super().__init__()
...
class Decoder(nn.Module):
    ...
    def __init__(self, out_channels=4):  # Changed from 1 to 4 for RGBA
        super().__init__()
...
class AutoregressiveRGBAGenerator(nn.Module):
    """
    ...
    def __init__(self, num_layers=18):
        ...
        self.encoder = Encoder(in_channels=4)  # RGBA input (4 channels)
        self.layer_embedding = LayerEmbedding(num_layers=num_layers, output_size=8)
        self.decoder = Decoder(out_channels=4)  # RGBA output (4 channels)
