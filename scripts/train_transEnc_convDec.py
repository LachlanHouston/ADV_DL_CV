"""
uses a Vision Transformer (ViT) as an encoder, followed by a purely convolutional decoder with transposed convolutions. 
It encodes image patches into tokens and decodes using convolutions directly.
"""
